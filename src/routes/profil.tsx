...
import { AvatarBox, AccountSettingsSheet } from "@/components/tooku/account-settings";
...
function ProfilePage() {
  ...
  const gearButton = (
    <button
      ...
      className="grid h-9 w-9 shrink-0 place-items-center rounded-full bg-primary-foreground/15 text-primary-foreground transition hover:bg-primary-foreground/30"
    >
      ...
      <div className="min-h-screen bg-secondary/40">
        <header className="bg-primary px-4 pb-10 pt-6 text-primary-foreground">
          <div className="mx-auto flex max-w-2xl items-center gap-3">
            ...
            <div className="ml-auto">{gearButton}</div>
          </div>
        </header>
    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="mx-auto -mt-5 max-w-2xl space-y-4 px-4">
        ...
        <div className="divide-y divide-border overflow-hidden rounded-2xl border border-border bg-card">
          ...
          >
            <Settings className="h-4 w-4 text-primary" /> Pengaturan Akun
            <span className="ml-auto text-[11px] text-muted-foreground">Foto, nama, email, kata sandi</span>
